  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <div className="flex space-x-2">
          ...
          <button
              ...
              className="text-center align-center  px-3 py-2 bg-amber-500 text-white rounded-md hover:bg-amber-600 transition-colors disabled:bg-amber-300"
            >
            Start Scraping
          </button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <StatCard 
          title="Total Food Bills" 
          value={totalFoodBills.toString()} 
          icon={<Leaf className="w-8 h-8 text-green-500" />}
          description="Total number of food-related bills"
        ...
        <StatCard 
          ...
          icon={<Clock className="w-8 h-8 text-yellow-800" />}
